...
from functions import csv_to_dict, make_collections, confirm_creation, show_current_dates, check_user_appt, \
    make_user_appt, find_open_appts_locations, find_max_appts_locations
